      ...
      <div className="w-full max-w-3xl mx-auto">
        <div className="w-full h-auto bg-gradient-to-tl from-secondary to-primary rounded-xl p-4">
          ...
          <ul className="flex justify-center items-center gap-4">
            <li><button className="size-12 bg-bg-muted rounded-full grid place-content-center text-2xl cursor-pointer">▶️</button></li>
            <li><button className="size-12 bg-bg-muted rounded-full grid place-content-center text-2xl cursor-pointer">🔁</button></li>
          </ul>
          </div>
        </div>
      </div>
